...
> **AVG版的Cursor** - 专为AI时代设计的低门槛文字互动游戏创作工具

基于AI Native的AVG文字游戏开发引擎，使用强大的Ink脚本语言，让创作者能够轻松制作精彩的互动小说和AVG游戏，一键打包成STEAM游戏。
...
- **Monaco编辑器**：专业级代码编辑体验，语法高亮、智能补全
- **实时预览**：边写边看，即时查看游戏效果
- **可视化节点图**：直观展示剧情分支和故事流程
- **欢迎页面**：类似VSCode的优雅启动体验

### 🛡️ 可靠性保障
- **崩溃恢复**：自动备份工作状态，意外关闭后智能恢复
- **文件监控**：实时检测外部文件变更，支持多人协作
- **版本管理**：完整的Git集成支持
- **自动保存**：智能防丢失机制
